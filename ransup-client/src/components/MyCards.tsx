...
import { getUsersCards } from "../services/cardsService";
    ...
    return (<>
        <div className="container">
            ...
            {cards.length ? (
                <div className="container">
                    {cards.map((card: Card) =>
                    (<div className={`card mb-3 mt-2 w-100 ${classes.color} ${classes.background}`} key={card._id}>
                        <div className="row g-0">
                            ...
                            <div className="col-md-8">
                                ...
                                <div className={`card-footer text-start ${classes.background}`}>
                                    ...
                                    <NavLink to={`/cards/edit/${card._id}`}><i className={`fa-regular fa-pen-to-square ${classes.color}`} style={{ fontSize: "1.5rem", marginRight: "1rem" }}></i></NavLink>
                                </div>
                            </div>
                        </div>
                    </div>)
