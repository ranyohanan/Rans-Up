        ...
        <div className="App">
          ...
          <Router>
            ...
            <Routes>
              ...
              <Route path='/register' element={<Register darkMode={darkMode} setUserInfo={setUserInfo} setIsLoggedIn={setIsLoggedIn} />} />
              <Route path='/:id' element={<CardDetails darkMode={darkMode} />} />
              ...
              <Route path='/favCards' element={<FavCards userInfo={userInfo} darkMode={darkMode} />} />
